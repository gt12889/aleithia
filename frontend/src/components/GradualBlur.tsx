...
const mergeConfigs = (...configs: Partial<typeof DEFAULT_CONFIG>[]) =>
  configs.reduce((acc, c) => ({ ...acc, ...c }), {} as typeof DEFAULT_CONFIG)
...
function GradualBlur(props: GradualBlurProps) {
  ...
  const blurDivs = useMemo(() => {
    ...
    const currentStrength =
      isHovered && config.hoverIntensity ? config.strength * (config.hoverIntensity as number) : config.strength
